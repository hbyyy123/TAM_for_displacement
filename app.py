...
def sam_refine(video_state, point_prompt, click_state, interactive_state, evt: gr.SelectData):
    ...
    video_state["painted_images"][video_state["select_frame_number"]] = np.asarray(painted_image)
...
def generate_video_from_frames(frames, output_path, fps=30):
    ...
    Ensures fps is a native int to avoid PyAV errors.
    """
    # 转为 Tensor
    frames_t = torch.from_numpy(np.asarray(frames))
    # 建文件夹
...
e2fgvi_checkpoint = "E2FGVI-CVPR22.pth"
